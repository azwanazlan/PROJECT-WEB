...
WebUI.selectOptionByLabel(findTestObject('PROJECT WEB/Employee List/Page_OrangeHRM/selectSubUnit'), 'Human Resources', true)

WebUI.click(findTestObject('PROJECT WEB/Employee List/Page_OrangeHRM/searchButton'))

WebUI.verifyElementPresent(findTestObject('PROJECT WEB/Employee List/Page_OrangeHRM/td_Human Resources'), 5)
