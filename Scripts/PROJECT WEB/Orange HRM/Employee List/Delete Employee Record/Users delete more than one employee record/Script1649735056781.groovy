...
WebUI.check(findTestObject('PROJECT WEB/Employee List/Page_OrangeHRM/checkBoxSecond'))

WebUI.check(findTestObject('PROJECT WEB/Employee List/Page_OrangeHRM/checkBoxThird'))
