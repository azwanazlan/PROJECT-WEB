...
WebUI.setText(findTestObject('PROJECT WEB/Pay Grade/currencyName'), 'RM')

WebUI.click(findTestObject('PROJECT WEB/Pay Grade/saveCurrencyButton'))

WebUI.verifyElementPresent(findTestObject('PROJECT WEB/Pay Grade/verifyInvalidCurrency'), 5)
