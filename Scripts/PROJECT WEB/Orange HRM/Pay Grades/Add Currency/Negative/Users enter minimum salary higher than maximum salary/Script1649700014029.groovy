...
WebUI.click(findTestObject('PROJECT WEB/Pay Grade/addCurrencyButton'))

WebUI.setText(findTestObject('PROJECT WEB/Pay Grade/currencyName'), 'Singapore Dollar')

WebUI.sendKeys(findTestObject('PROJECT WEB/Pay Grade/currencyName'), Keys.chord(Keys.ENTER))

WebUI.setText(findTestObject('PROJECT WEB/Pay Grade/minimumSalary'), '2000')

WebUI.setText(findTestObject('PROJECT WEB/Pay Grade/maximumSalary'), '1500')

WebUI.click(findTestObject('PROJECT WEB/Pay Grade/saveCurrencyButton'))

WebUI.verifyElementPresent(findTestObject('PROJECT WEB/Pay Grade/verifyShouldBeHigherThanMinimumSalary'), 5)
