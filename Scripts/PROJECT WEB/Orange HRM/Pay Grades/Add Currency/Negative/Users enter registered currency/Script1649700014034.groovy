...
WebUI.setText(findTestObject('PROJECT WEB/Pay Grade/currencyName'), 'Malaysian Ringgit')
...
WebUI.verifyElementPresent(findTestObject('PROJECT WEB/Pay Grade/verifyCurrencyAlreadyExists'), 5)
