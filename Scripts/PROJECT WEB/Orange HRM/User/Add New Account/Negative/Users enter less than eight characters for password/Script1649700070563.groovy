...
WebUI.setText(findTestObject('PROJECT WEB/User/Page_OrangeHRM/input__systemUserpassword'), 'abc123')

WebUI.setText(findTestObject('PROJECT WEB/User/Page_OrangeHRM/input__systemUserconfirmPassword'), 'abc123')

WebUI.verifyElementPresent(findTestObject('PROJECT WEB/User/Page_OrangeHRM/span_Should have at least 8 characters'), 5)
