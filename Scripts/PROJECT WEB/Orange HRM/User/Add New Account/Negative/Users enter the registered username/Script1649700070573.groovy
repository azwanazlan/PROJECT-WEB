...
WebUI.setText(findTestObject('PROJECT WEB/User/Page_OrangeHRM/input__systemUseruserName'), 'HarryKane')

WebUI.verifyElementPresent(findTestObject('PROJECT WEB/User/Page_OrangeHRM/span_Already exists'), 5)
