...
WebUI.setText(findTestObject('PROJECT WEB/User/Page_OrangeHRM/input__systemUseruserName'), 'HarryKane200')
...
WebUI.setText(findTestObject('PROJECT WEB/User/Page_OrangeHRM/input__systemUserconfirmPassword'), 'abcd123')

WebUI.click(findTestObject('PROJECT WEB/User/Page_OrangeHRM/input__btnSave'))

WebUI.verifyElementPresent(findTestObject('PROJECT WEB/User/Page_OrangeHRM/span_Passwords do not match'), 5)
