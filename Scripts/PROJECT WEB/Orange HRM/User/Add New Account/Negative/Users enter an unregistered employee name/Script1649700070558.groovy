...
WebUI.setText(findTestObject('PROJECT WEB/User/Page_OrangeHRM/input__systemUseremployeeNameempName'), ' Peter Parker')

WebUI.setText(findTestObject('PROJECT WEB/User/Page_OrangeHRM/input__systemUseruserName'), 'Peter Parker')

WebUI.selectOptionByValue(findTestObject('PROJECT WEB/User/Page_OrangeHRM/select_EnabledDisabled'), '1', true)

WebUI.setText(findTestObject('PROJECT WEB/User/Page_OrangeHRM/input__systemUserpassword'), GlobalVariable.createUserPassword)

WebUI.setText(findTestObject('PROJECT WEB/User/Page_OrangeHRM/input__systemUserconfirmPassword'), GlobalVariable.createUserPassword)

WebUI.click(findTestObject('PROJECT WEB/User/Page_OrangeHRM/input__btnSave'))

WebUI.verifyElementPresent(findTestObject('PROJECT WEB/User/Page_OrangeHRM/span_Employee does not exist'), 5)
