...
WebUI.setText(findTestObject('PROJECT WEB/User/Page_OrangeHRM/input__systemUseruserName'), 'Harr')

WebUI.verifyElementPresent(findTestObject('PROJECT WEB/User/Page_OrangeHRM/span_Should have at least 5 characters'), 5)
