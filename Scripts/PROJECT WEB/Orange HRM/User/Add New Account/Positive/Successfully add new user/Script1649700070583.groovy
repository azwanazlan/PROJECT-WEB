...
WebUI.setText(findTestObject('PROJECT WEB/User/Page_OrangeHRM/input__systemUseruserName'), username)

WebUI.selectOptionByValue(findTestObject('PROJECT WEB/User/Page_OrangeHRM/select_EnabledDisabled'), '1', true)

WebUI.setText(findTestObject('PROJECT WEB/User/Page_OrangeHRM/input__systemUserpassword'), password)

WebUI.setText(findTestObject('PROJECT WEB/User/Page_OrangeHRM/input__systemUserconfirmPassword'), password)
