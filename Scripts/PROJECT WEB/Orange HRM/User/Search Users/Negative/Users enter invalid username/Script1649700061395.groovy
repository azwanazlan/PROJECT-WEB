...
WebUI.setText(findTestObject('PROJECT WEB/User/Page_OrangeHRM/input username'), 'Ali')

WebUI.click(findTestObject('PROJECT WEB/User/Page_OrangeHRM/search button'))

WebUI.verifyElementPresent(findTestObject('PROJECT WEB/User/Page_OrangeHRM/td_No Records Found'), 5)
